CREATE TABLE regions (
    region_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 6 PRIMARY KEY,
...
CREATE TABLE products (
    product_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 300 PRIMARY KEY,
...
CREATE TABLE customers (
    customer_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 400 PRIMARY KEY,
...
CREATE TABLE contacts (
    contact_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 400 PRIMARY KEY,
...
CREATE TABLE orders (
    order_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 150 PRIMARY KEY,
