...
public class Warehouse {
	...
	public Warehouse(long wareHouseId, long locationId, String wareHouseName) throws DatoIncorrrectoException {
	...
	public Warehouse(long locationId, String wareHouseName) throws DatoIncorrrectoException {
		if (wareHouseName == null) {
			throw new DatoIncorrrectoException("Los campos no pueden estar vacios");
		}
	...
	public Warehouse(long wareHouseId) throws DatoIncorrrectoException {
		if (wareHouseId <= 0) {
