		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (opcionUbicacion == -1 || listaLocations == null || listaLocations.isEmpty()) {
						JOptionPane.showMessageDialog(null, "Debes seleccionar una ubicación válida.", "Error",
	...
	private void cargarUbicacionesPorPais() {
		try {
			...
			if (listaLocations.isEmpty()) {
				...
				for (Location ubicacion : listaLocations) {
